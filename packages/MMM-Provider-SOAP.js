...
Module.register("MMM-Provider-SOAP", {
	...
	defaults: {
		...
		input:'URL',		// 'URL' (default)
		id: '',				// the id of this module that must be unique
		baseurl: '',		// the fixed part of the SOAP POST url
		basedata: '',		// the fixed part of the SOAP request to be sent in the body of the request
		baseheaders: '',	// the fixed part of the SOAP request headers
		package:'',			// name of a package that overrides all settings from the config.js if present
